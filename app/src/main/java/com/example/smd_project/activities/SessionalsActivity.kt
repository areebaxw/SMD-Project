        ...
        lifecycleScope.launch {
            try {
                ...
                if (response.isSuccessful && response.body()?.success == true) {
                    ...
                    Toast.makeText(this@SessionalsActivity, "Failed to load marks", Toast.LENGTH_SHORT).show()
                }
            } catch (e: Exception) {
                Toast.makeText(this@SessionalsActivity, "Error: ${e.message}", Toast.LENGTH_SHORT).show()
            }
        }
    }
