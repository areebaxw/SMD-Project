        ...
        lifecycleScope.launch {
            try {
                ...
                if (response.isSuccessful && response.body()?.success == true) {
                    ...
                    Toast.makeText(this@FinalsActivity, "Failed to load marks", Toast.LENGTH_SHORT).show()
                }
            } catch (e: Exception) {
                Toast.makeText(this@FinalsActivity, "Error: ${e.message}", Toast.LENGTH_SHORT).show()
            }
        }
    }
